...
class Node {
    ...
    protected void createHead(int[] values) {
        ...
        this.head = head;
        System.out.print("Формирование списка c головы: ");
    }
    ...
    protected void createTail(int[] values) {
        ...
        this.head = head;
        System.out.print("Формирование списка c хвоста: ");
    }
    ...
    protected void Insert(int middle, int queue) {
        ...
        ref.next = newNode;
        System.out.print("Добавление элемента № " + queue + " в список:");
    }

    protected void RemoveFirst() {
        this.head = this.head.next;
        System.out.print("Удаление элемента с головы списка:");
    }
    ...
    protected void RemoveLast() {
        ...
        ref.next = null;
        System.out.print("Удаление элемента с хвоста списка:");
    }
    ...
    protected void Remove(int queue) {
        ...
        System.out.print("Удаление из списка под № " + queue +":");
    }

    Node createHeadRec(int value) {
        if (value == 0) {
            System.out.print("Формирование списка с головы с помощью рекурсии: ");
            return null;
        }
    ...
    int createTailRec(int value){
        if (value ==0) {
            System.out.print("Формирование списка с хвоста с помощью рекурсии:");
            Node head = null;
            this.head = head;
            return 0;
        }
