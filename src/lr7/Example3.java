...
public class Example3 {
    public static void main(String[] args) {
        SuperClass3 superClassTest = new SuperClass3(100);
        String className = superClassTest.toString();
        System.out.println(className);

        PodClass3 Sub2ClassTest = new PodClass3(200,'П');
        String subclassName2 = Sub2ClassTest.toString();
        System.out.println(subclassName2);

        PodClass3_3 Sub3ClassTest = new PodClass3_3(200,'П',"Программа");
        String subclassName3 = Sub3ClassTest.toString();
